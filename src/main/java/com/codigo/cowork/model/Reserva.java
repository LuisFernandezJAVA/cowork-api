...
public class Reserva {
    ...
    public Reserva(Long id, Long salaId, String responsable, String email, LocalDate fecha,
                   LocalTime horaInicio, LocalTime horaFin, String estado, String passwordInterno) {
        this.id = id;
        this.salaId = salaId;
